 ...
 *****************************************
 修改日期：2016-04-16
 进展：
 1、优化CaptureDialog视觉效果
 2、修正无法打开视频所在的目录是中文路径文件夹的问题

 *****************************************
 修改日期：2016-04-15
 进展：
 1、截图可以复制到剪切板
 2、通过添加mainLabel  解决暂停视频时，移动窗口黑屏的问题
 3、修正鼠标离开窗体时，bottomWidget无法隐藏的问题
 ...
 *****************************************
 ...
 1、实现截图功能
 2、设计CaptureDialog布局
 3、可以通过bottomWidget移动captureDialog
 4、可以通过图像移动captureDialog
